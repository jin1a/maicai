                ...
                <view class="box-container">
                    <view class="reportFormsItem">
                        <block v-if="data.total > 0">
                            <reportForms :lists="data.data" url="tofuBoard" :title="data.title"></reportForms>
                        </block>
                    </view>
                </view>
            </view>
        </view>
        <queryReportBottom :total="data.total" url="tofuBoard"></queryReportBottom>
    </view>
</template>
